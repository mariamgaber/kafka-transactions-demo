package com.kafka.withdrawal.configurations;
...
import com.kafka.payments.core.error.NotRetryableException;
import com.kafka.payments.core.error.RetryableException;
...
public class KafkaConsumerConfiguration {
	...
	ConsumerFactory<String, Object> consumerFactory() {
		...
		// The consumer will not read the messages unless the Kafka transaction has been committed.
